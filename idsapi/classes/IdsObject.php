...
require_once(dirname(__FILE__) . '/IdsObjectAsset.php');
require_once(dirname(__FILE__) . '/IdsObjectAssetDocument.php');
require_once(dirname(__FILE__) . '/IdsObjectAssetOrganization.php');
require_once(dirname(__FILE__) . '/IdsObjectCategory.php');
require_once(dirname(__FILE__) . '/IdsObjectCountry.php');
