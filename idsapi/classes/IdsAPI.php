...
require_once(dirname(__FILE__) . '/IdsAbstract.php');
require_once(dirname(__FILE__) . '/IdsResponseFactory.php');
...
class IdsAPI extends IdsAbstract {

    
    protected $api_key;
    
    protected $api_key_par;
    ...
    // Type of request.
    protected $type_request = parent::IDS_DEFAULT_TYPE_REQUEST;    
    ...
    protected $format = parent::IDS_DEFAULT_FORMAT;
    ...
    protected function buildUrl() {
        ...
        if (($this->getTypeRequest() === parent::IDS_TYPE_REQUEST_SEARCH) 
                || ($this->getTypeRequest() === parent::IDS_TYPE_REQUEST_GET_ALL)) {
